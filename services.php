    ...
    <main>
        ...
        <header class="page header color-1 overlay alpha-8 image-background cover overlay gradient gradient-43" style="background-image: url('img/bg/waves.jpg')">
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="regular display-4 color-1 mb-4">Our Services</h1>
                        <p class="lead color-1">Simple and affordable our services. Try Dashcore with no obligation</p>
                    </div>
                </div>
            </div>
        </header>
            ...
            <div class="container">
                ...
                <div class="row gap-y text-center text-md-left">
                    <div class="col-md-4"><i class="pe pe-3x color-4 pe-7s-headphones icon m-0"></i>
                    ...
                    <div class="col-md-4"><i class="pe pe-3x color-4 pe-7s-plugin icon m-0"></i>
                    ...
                    <div class="col-md-4"><i class="pe pe-3x color-4 pe-7s-door-lock icon m-0"></i>
                        <h5 class="bold my-3">Total control of your code</h5>
                        <p class="my-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci atque beatae dicta dolores hic porro quam voluptatibus.</p>
                    </div>
                    <div class="col-md-4"><i class="pe pe-3x color-4 pe-7s-airplay icon m-0"></i>
                        <h5 class="bold my-3">Responsive design</h5>
                        <p class="my-0">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Adipisci atque beatae dicta dolores hic porro quam voluptatibus.</p>
                    </div>
                    <div class="col-md-4"><i class="pe pe-3x color-4 pe-7s-browser icon m-0"></i>
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="accordion accordion-clean" id="common-faqs-accordion">
                            <div class="card mb-3">
                                <div class="card-header"><a href="#" class="card-title btn" data-toggle="collapse" data-target="#q1">What does the package include?</a></div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header"><a href="#" class="card-title btn" data-toggle="collapse" data-target="#q2">What is the typical response time for a support question?</a></div>
                            ...
                            <div class="card mb-3">
                                <div class="card-header"><a href="#" class="card-title btn" data-toggle="collapse" data-target="#q3">What do I need to know to customize this template?</a></div>
                            ...
                            <div class="card">
                                <div class="card-header"><a href="#" class="card-title btn" data-toggle="collapse" data-target="#q4">Can I suggest a new feature?</a></div>
        ...
        <section class="section">
            <div class="container bring-to-front">
                <div class="shadow rounded text-center bg-4-gradient color-1 p-5">
                    ...
                    <p class="handwritten highlight font-md">Why wait? Start now!</p><a href="signup.html" class="btn btn-5 btn-rounded mt-4">Start now</a></div>
            </div>
        </section>
        <!-- ./CTA - Create Account -->
            ...
            <div class="container pt-5">
                <div class="d-flex align-items-center flex-column flex-md-row">
                    <div class="text-center text-md-left">
                        ...
                        <h2 class="mt-0">Create an account now</h2></div><a href="register.html" class="btn btn-accent btn-rounded mt-3 mt-md-0 ml-md-auto">Create DashCore account</a></div>
            </div>
        </section>
    </main>
