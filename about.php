...
<style>
        .bg-6.edge.top-left::before{ top:0 !important;}
    </style>
<body>
    <!-- ./Main Navigation -->
    ...
    <main class="position-relative overflow-hidden">
        ...
        <header class="page header color-1 overlay alpha-8 image-background cover gradient gradient-43" style="background-image: url('img/bg/waves.jpg')">
            ...
            <div class="container" style="">
                <div class="row">
                    <div class="col-md-6">
                        <h1 class="regular display-4 color-1 mb-4">About iSoftMinds</h1>
                        <p class="lead color-1">iSoftMinds is an all included HTML template, it's packed with a admin dashboard template to help you get started with your project.</p>
                    </div>
                </div>
            </div>
        </header>
                ...
                <div class="row align-items-center gap-y">
                    <div class="col-lg-5 mr-auto text-center text-md-left">
                        <div class="section-heading">
                            <p class="badge badge-success bold">Succeed with iSoftMinds</p>
                            <h2>The new way to showcase your Startup</h2>
                            <p class="lead color-2">iSoftMinds is a Bootstrap 4 HTML template. Designed to help you promote your solution in an easy and beautiful way.</p>
                        </div>
                        <p>It includes multiple components and pre-made demos ready for you to personalize according to your own needs. iSoftMinds includes a ready-to-go Admin Dashboard with many out-of-the-box features.</p>
                    </div>
                    <div class="col-lg-6">
                        <div class="row gap-y">
       ...
       <!-- <section class="section">
            <div class="container bring-to-front">
                <div class="shadow rounded text-center overlay overlay-5 alpha-8 color-1 p-5 image-background cover" style="background-image: url(https://picsum.photos/350/200/?random&amp;gravity=south)">
                    <div class="content">
                        <div class="section-heading">
                            <h2 class="color-1">Discover how iSoftMinds works</h2></div>
                        <p class="handwritten highlight font-md">Play the video</p><a href="https://www.youtube.com/watch?v=MXghcI8hcWU" class="modal-popup mfp-iframe btn btn-circle btn-lg btn-accent" data-effect="mfp-fade"><i class="pe pe-7s-play pe-2x ml-2"></i></a></div>
                </div>
            </div>
        </section>-->
        <!-- ./Dashboard Included -->
        <section class="section bg-6 edge top-left">
            <div class="container bring-to-front">
                ...
                <div class="row align-items-center gap-y">
                    <div class="col-md-6 col-lg-5 text-center text-md-left">
                        <ul class="list-unstyled">
                            <li class="media d-block d-lg-flex"><i class="pe pe-3x pe-7s-plugin accent icon-lg mr-3 text-lg-right"></i>
                                <div class="media-body mt-3 mt-lg-0 text-center text-md-left">
                                    <h5 class="bold color-5">Full Code</h5>
                                    <p class="mt-0 mb-5">iSoftMinds comes with fully documented HTML, SASS, JS, PHP code, all in a well organized and structured way.</p>
                                </div>
                            </li>
                            <li class="media d-block d-lg-flex"><i class="pe pe-3x pe-7s-tools accent icon-lg mr-3 text-lg-right"></i>
                                <div class="media-body mt-3 mt-lg-0 text-center text-md-left">
                            ...
                            <li class="media d-block d-lg-flex"><i class="pe pe-3x pe-7s-medal accent icon-lg mr-3 text-lg-right"></i>
                                <div class="media-body mt-3 mt-lg-0 text-center text-md-left">
                    ...
                    <div class="col-md-6 col-lg-5 ml-md-auto">
                        <div class="shadow card">
                            <div class="card-header overlay gradient gradient-34 alpha-5 image-background cover" style="background-image: url(img/screens/dash/4.png)">
                                <div class="content">
                                    <h2 class="mt-9 color-1 light">Dashboard Included</h2></div>
                            </div>
                            <div class="card-body">
                                <p>Our template is packed with a <span class="bold">Starter Admin Dashboard</span> to help you get started right away with your project. You'll have not a beautiful HTML template to promote your product but a starting point admin template</p><a href="admin/index" class="btn btn-accent btn-rounded mt-4">Try the Dashboard</a></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <section class="bg-1 edge top-left">
            <div class="container">
                <div class="row">
                    <div class="col-xs-4 col-md-3 text-center"><i class="pe pe-7s-plugin pe-3x accent"></i>
                        <p class="counter bold color-5 font-md mt-0">273</p>
                        <p class="color-2 m-0">Components</p>
                    </div>
        ...
        <section class="section features bg-6-gradient">
            <div class="container">
                <div class="section-heading text-center">
                    ...
                    <p class="lead color-2">Take the control of your web with iSoftMinds. You can customize the theme according to your needs or just use the ready-to-use content we made for you</p>
                </div>
                <div class="row gap-y">
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-phone"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-tools"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-medal"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-star"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-paper-plane"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-headphones"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-pendrive"></i>
                    ...
                    <div class="col-md-3">
                        <div class="shadow-box shadow-hover border-0 card">
                            <div class="card-body text-center"><i class="w-50 pe pe-3x pe-7s-plugin"></i>
        ...
        <!-- <section class="section bg-1 edge bottom-right">
            <div class="container">
                ...
                <ul class="list-unstyled d-flex flex-wrap justify-content-around">
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-right" data-aos-delay="0" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-6" style="background-image: url(img/logos/1.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-down-right" data-aos-delay="100" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-4" style="background-image: url(img/logos/2.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-up-right" data-aos-delay="200" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-5" style="background-image: url(img/logos/3.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-up" data-aos-delay="300" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-6" style="background-image: url(img/logos/4.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-down-left" data-aos-delay="400" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-4" style="background-image: url(img/logos/5.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-up-left" data-aos-delay="0" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-5" style="background-image: url(img/logos/1.png)"></li>
                    <li data-aos-easing="ease-in-out-cubic" data-aos="fade-left" data-aos-delay="100" class="shadow-box bg-6 rounded-circle icon-xxl image-background contain mt-6" style="background-image: url(img/logos/2.png)"></li>
                </ul>
                <div class="text-center mt-6"><i class="pe pe-7s-plug pe-3x accent"></i>
                    <p class="accent">Are you a developer?</p><a href="developers" class="btn btn-rounded btn-accent">Review the specs</a></div>
            </div>
        </section>-->
        <!-- ./Team -->
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/1.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
                        ...
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/2.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
                        ...
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/3.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
                        ...
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/4.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
                        ...
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/5.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
                        ...
                        <div class="swiper-slide">
                            <div class="card shadow">
                                <div class="container-fluid py-0">
                                    <div class="row">
                                        <div class="col-md-5 py-9 py-sm-7 overlay overlay-5 alpha-2 image-background cover center-top" style="background-image: url(img/avatar/team/6.jpg)"></div>
                                        <div class="col-md-7">
                                            <div class="p-4">
        ...
        <section class="section bg-6">
            <div class="container">
                <h4 class="bold text-center mb-5 color-2">They trust us</h4>
                <div class="row gap-y">
            ...
            <div class="container bring-to-front py-0">
                <div class="shadow bg-1 p-5 rounded">
                    <div class="row gap-y align-items-center text-center text-lg-left">
                        <div class="col-12 col-md-6 py-4 px-5 b-md-r"><i class="pe pe-7s-diamond pe-3x color-3"></i> <a href="javascript:void(0)" class="mt-4 color-3 d-flex align-items-center"><h4 class="mr-3">Join as Designer</h4><i class="fas fa-long-arrow-alt-right"></i></a>
                        ...
                        <div class="col-12 col-md-6 py-4 px-5"><i class="pe pe-7s-science pe-3x color-4"></i> <a href="javascript:void(0)" class="mt-4 color-4 d-flex align-items-center"><h4 class="mr-3">Join as Developer</h4><i class="fas fa-long-arrow-alt-right"></i></a>
                            <p class="mt-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Asperiores, consequuntur fugit minima natus optio quisquam sint sunt? Earum harum in laudantium nobis obcaecati odio, praesentium, quis sequi soluta vel veniam.</p>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 b-md-r">
                        <h2>iSoftMinds official <span class="bold">Newsletter</span></h2></div>
